  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        />
        <title>
          Bimbel Persiapan Seleksi Beasiswa LPDP di Kabupaten {`${id}`} #1 - Edumatrix
          Indonesia
        </title>
        ...
        <div className="content-kabupaten">
          <div className="teks-content">
            <h2 className="title-halaman-kabupaten">
              Bimbel Persiapan Seleksi Beasiswa LPDP di Kabupaten {id} - Edumatrix
              Indonesia
            </h2>
            <div className="paragraf-kabupaten">
              <p>
                Jasa Les Privat di Kabupaten {id} untuk Seleksi Beasiswa LPDP luar
                dan dalam Negeri
              </p>
