  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        />
        <title>
          Bimbel Persiapan Seleksi CPNS & PPPK di Kabupaten {`${id}`} #1 - Edumatrix
          Indonesia
        </title>
        ...
        <div className="content-kabupaten">
          <div className="teks-content">
            <h2 className="title-halaman-kabupaten">
              Bimbel Persiapan Seleksi CPNS & PPPK di Kabupaten {id} - Edumatrix
              Indonesia
            </h2>
            <div className="paragraf-kabupaten">
              <p>
                Jasa Les Privat di Kabupaten {id} untuk Seleksi CPNS & PPPK luar
                dan dalam Negeri
              </p>
